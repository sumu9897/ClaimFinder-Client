      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-300">
            <li>
              ...
              <a
                href="mailto:info@whereisit.com"
            ...
            <li>
              <span className="font-medium">Address:</span> 123 Explorer Lane, Dhaka, Bangladesh
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-300 mb-4">
            Subscribe for the latest updates on new places and travel tips.
          </p>
